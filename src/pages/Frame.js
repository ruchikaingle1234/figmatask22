  ...
  return (
    <div className="frame">
      ...
      <div className="stack">
        <div className="bar">
          <div className="this-page-is-included-in-a-fre-parent">
            ...
            <div className="view-the-complete-kit-parent">
              ...
              <a href="#section1"><img className="icons" alt="" src="/icons.svg" /></a>
            </div>
          </div>
        </div>
              ...
              <div className="tag">
                <div className="version-20-is-here-parent">
                  ...
                  <div className="read-more-parent">
                   ...
                   <a href="#section2"> <img className="icons" alt="" src="/icons.svg" /></a>
                  </div>
                </div>
              </div>
              <b className="h1">
        ...
        <div className="grid" id="section1">
        ...
        <div className="sign-up" id="section2">
